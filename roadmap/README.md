...
| 步骤 | 工作内容 | 交付物 | 状态 |
| --- | --- | --- | --- |
| 1 | 冻结首次试跑契约，明确 8 个模块、依赖方向、`Money` 行为和验收条件 | `specs/pilot/system-design.md` | 已完成 |
| 2 | 建设首次试跑需要的最小上下文和执行入口 | `AGENTS.md`、Conventions、Guardrails、Templates、Workflow、Skill、Feedback、Observability | 已完成 |
| 3 | 由 Coordinator 创建运行并拆解任务，经用户确认后进入执行 | `manifest.md`、`task-breakdown.md` | 进行中 |
